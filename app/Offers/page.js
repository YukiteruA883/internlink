...
export default function Service() {
    ...
    function handleAccept(offer) {
        ...
        fetch("https://35.240.139.137:3001/internships/add", {
            method: "POST",
    ...
    function getOffers() {
        fetch("https://35.240.139.137:3001/offers/all").then((response) => response.json()).then((res) => setOffers(res.result))
        
    }

    function getSomething() {
        fetch("https://35.240.139.137:3001/users").then((response) => response.json()).then((res) => console.log(res))
    }
    ...
    function setInternships() {
        ...
        fetch("https://35.240.139.137:3001/offers", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(data) }).then(getOffers())
    }

    function deleteOffer(id) {
        fetch(`https://35.240.139.137:3001/offers/${id}`, { method: "DELETE", headers: { "Content-Type": "application/json" } }).then(getOffers())
    }
    ...
    function updateOffer(id) {
        ...
        fetch(`https://35.240.139.137:3001/offers/${id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(data) }).then(getOffers())
    }
